...
/**
 * Servlet implementation class a_co_entry
 */
@WebServlet("/a_co_entry")
public class a_co_entry extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher =
				request.getRequestDispatcher("WEB-INF/jsp/admin/a_co_entry.jsp");
